...
class Match extends DatabaseObject{
	...
	protected static $db_fields=array('id','published', 'team1_id','team2_id','date','time','team1_goals','team2_goals','team1_reds','team2_reds','team1_yellows','team2_yellows', 'notes');
	public $id;
	public $published;
	public $team1_id;
	public $team2_id;
