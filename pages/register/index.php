  ...
  include_once('../../includes/emailer.php');
	...
	if(isset($_POST['commit'])){
      ...
      $mail_sent = @mail( $to, $subject, $body, $headers );
  		if($mail_sent){redirect_to("registration_complete.html");}
  	}
  }  
?>
    ...
    <tr>
      <td align="center" valign="middle">
  		<div id="page">
              ...
              <br/>
              <p>Compilare il modulo di pre-iscrizione ADVERTBALL 2009-2010 sul sito Internet entro il 9 Ottobre 2009.</p>
              <br/>
              ...
              <form name="_form" action="<?php echo $_SERVER['PHP_SELF']?>" id="_form" method="post" onSubmit="return yav.performCheck('_form', rules, 'inline');">
                <table width="600" height="435" border="0" cellspacing="0" cellpadding="0" class="sx">
                    ...
                    <td><span id="errorsDiv_rules_term"></span></td>
              		...
              		<tr>
              		  <td colspan="3" align="right"><input id="commit" name="commit" class="send" type="submit" value="" /></td>
              		</tr>
              	</table>
              </form>
              <p class="last">&nbsp;</p>
  				...
  				<div id="footer"><a href="../static/faq.html">Faq</a> &bull; <a href="../static/contact.html">Contatti</a></div>
  			</div>
  		</div>
  	</td>
    </tr>
