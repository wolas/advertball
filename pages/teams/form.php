		...
		if($team->save()){
  		if(!empty($_FILES['logo'])){
  		  ...
  		  $extension = substr($value, strrpos($value, '.') + 1);
  			$filename = $upload_dir . "logo" . "." . $extension;
  			move_uploaded_file($_FILES['logo']['tmp_name'], $filename);
  		  $team->logo = "logo" . "." . $extension;
  		  $team->save();
  		}
...
<head>
  ...
  <script>
    ...
    rules[8]='userfile:Logo|required';
  </script>
</head>
<body>
    			  ...
    			  <h2><img src="../../images/new_team.gif" /></h2>
                	...
                	<table class="edit_table">
                		...
                		<tr><td colspan="3">&nbsp;</td></tr>
    					      <tr>
                			<td>Logo:</td>
                			<td><input id="logo" type="file" name="logo" size="33"/></td>
    	    				    <td class="right_column"><span id="errorsDiv_logo"></span></td>
                		</tr>
                		<tr><td colspan="3">&nbsp;</td></tr>
                		<tr>
