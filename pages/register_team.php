<?php 
	...
	if(!$agency->create()){
		...
		$body = "Thankyou for registering. You have submitted the foloowing details:<br /> <br /> " .
				"<b>Company Name:</b> " . $_POST['company_name'] . "<br />" .
				"<b>Street:</b> " . $_POST['city'] . "<br />" .
				"<b>City:</b> " . $_POST['city'] . "<br />" .
				"<b>Company State:</b> " . $_POST['state'] . "<br />" .
				"<b>Postcode:</b> " . $_POST['postcode'] . "<br />" .
				"<b>Contact Name:</b> " . $_POST['contact_name'] . "<br />" .
				"<b>Contact Telephone:</b> " .  $_POST['contact_telephone'] . "<br />" .
				
				"<b>Contact Email:</b> " . $_POST['contact_email']  . "<br />" .
				"<b>Partiva IVA:</b> " . htmlspecialchars($_POST['partita_iva']) . "<br />" .
				"<b>Agree to legal terms: " .  $agree . ".<br /><br />" .
				
				"From, 14 Spet. 20009, you can register you teams using following details:<br />" .
				 
				"<b>Username:</b>" . addslashes($_POST['username']) . "<br />" .
				"<b>Password:</b> " . $_POST['password'] . "<br /><br />" .
				"<a href=\"http://www.bbc.co.uk\">http://www.advertball.it</a>";
